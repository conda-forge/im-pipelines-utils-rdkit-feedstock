About im-pipelines-utils-rdkit-feedstock
========================================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/im-pipelines-utils-rdkit-feedstock/blob/main/LICENSE.txt)
...
Development: https://github.com/InformaticsMatters/pipelines-utils-rdkit

Documentation: https://github.com/InformaticsMatters/pipelines-utils-rdkit
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=8882&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/im-pipelines-utils-rdkit-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `im-pipelines-utils-rdkit` can be installed with `conda`:
...
```
mamba install im-pipelines-utils-rdkit
```

It is possible to list all of the versions of `im-pipelines-utils-rdkit` available on your platform with `conda`:
...
```
mamba search im-pipelines-utils-rdkit --channel conda-forge
```
...
mamba repoquery search im-pipelines-utils-rdkit --channel conda-forge

# List packages depending on `im-pipelines-utils-rdkit`:
mamba repoquery whoneeds im-pipelines-utils-rdkit --channel conda-forge

# List dependencies of `im-pipelines-utils-rdkit`:
mamba repoquery depends im-pipelines-utils-rdkit --channel conda-forge
```
